...
class User(AbstractUser):
    ...
    groups = models.ManyToManyField(Group, verbose_name='grupos', blank=True, help_text='The groups this user belongs to.', related_name='custom_user')
    user_permissions = models.ManyToManyField(Permission, verbose_name='permisos de usuario', blank=True, help_text='Specific permissions for this user.', related_name='custom_user')
